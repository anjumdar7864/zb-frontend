...
// import { FollowUpTemplateStyled, TableRowStyled } from "./stylesBackUp";
import {
  FaChevronDown,
  FaEdit,
  FaEllipsisV,
...
const InitialTemplate = () => {
  ...
  const queryParams = useMemo(
    () => ({
      limit, // Use limit instead of numberOfRowsShowing
      mode: "follow",
      page: currentPage,
      type: templateType,
      sortByDate:
  ...
  useLayoutEffect(() => {
    dispatch(getTemplateCounts({ mode: "follow" }));
  }, [dispatch]);
  ...
  const handleLimitChange = (event) => {
    ...
    setLimit(newLimit); // Update limit based on dropdown selection
  ...
  return (
    ...
    >
      <TemplateTop>
        <div className="left">
          {(user.role === "admin" ||
            user.permissions.includes("Follow-up Template Search")) && (
        ...
        >
          ...
          {(user.role === "admin" ||
            user.permissions.includes("Create Follow-up Template")) && (
            <LightTooltip
              placement="top"
              arrow
              title={
                <>
                  <p>Create New (FollowUp Template)</p>
                </>
              }
            >
              <Link to="/templates/create-template?follow=true">
                <div
                  style={{
                    width: "111px",
                    height: "40px",
        ...
        <div style={{ height: "calc(100% - 56px)", overflowX: "auto" }}>
          <div className="table">
            ...
            >
              <h6
                className={`col sort ${
                  sortingInfo.sortedBy === "name" ? "select" : ""
                }`}
              ...
              <h6
                className={`col sort info ${
                  sortingInfo.sortedBy === "messages" ? "select" : ""
                }`}
              ...
              <h6
                className={`col sort ${
                  sortingInfo.sortedBy === "type" ? "select" : ""
                }`}
              ...
              <h6
                className={`col sort info ${
                  sortingInfo.sortedBy === "delivery" ? "select" : ""
                }`}
    ...
    >
      ...
      <div className="col data">
        <p
          style={{
            color: `${
              parseFloat(singleTemplate?.deliveredPercentage) <= 84
                ? "#ff0000be"
                : "inherit"
            }`,
            fontWeight: `${
      ...
      {(user.role === "admin" ||
        user.permissions.includes("Edit Follow-up Template") ||
        user.permissions.includes("Delete Follow-up Template")) && (
          ...
          >
            {(user.role === "admin" ||
              ...
              <button
                onClick={() => {
                  setIsOpen(false);
                  navigate(`/templates/create-template/${_id}?follow=true`);
                }}
              >
                <span className="icon">
                  <FaEdit />

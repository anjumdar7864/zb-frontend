        ...
        <FormControl fullWidth>
          ...
          <Select
            ...
            renderValue={(selected) => (
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 , backgroundClip:"white" }}>
                {selected.map((value) => {
                  ...
                  return <span style={{backgroundColor:"white" , paddingLeft:"0px" , fontSize:"14px" , height:"20px" , borderRadius:"0px"}}  >{selectedStatus?.name},</span>;
                })}
              </Box>
            )}
          >

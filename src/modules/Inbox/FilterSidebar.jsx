...
export default function FilterSidebar({
    ...
    const selectStatus = (statuses) => {
        // console.log("check all filters ++", statuses);
    ...
    const list = (anchor) => (
        ...
        >
            <div style={{ display: "flex", justifyContent: "space-between", padding: "16px 24px", borderBottom: "solid 1px #D3D7DD" }}>
                <div>Filter</div> <div><IoMdClose style={{ cursor: "pointer" }} onClick={toggleDrawer('right', false)} /></div>
            ...
            <div style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "16px", flexGrow: 1 }}>
                ...
                <div style={{ display: "flex", justifyContent: "center", }}>
                    <div style={{ width: "387px", height: "48px", borderRadius: "8px", border: "solid 1px #D3D7DD", display: "flex", alignItems: "center", padding: "0px 12px", justifyContent: "space-between" }}>
                        <div style={{ color: "#012635", fontSize: "14px", fontWeight: 400 }}>Reminders</div>
                ...
                <div style={{ display: "flex", justifyContent: "center", }}>
                    <div style={{ width: "387px", height: "48px", borderRadius: "8px", border: "solid 1px #D3D7DD", display: "flex", alignItems: "center", padding: "0px 12px", justifyContent: "space-between" }}>
                        <div style={{ color: "#012635", fontSize: "14px", fontWeight: 400 }}>Push to CRM</div>
                        <div>
    ...
    return (
        <div>
            <div style={{ height: "48px", backgroundColor: "white", border: "solid 1px #D3D7DD", borderRadius: "8px", color: "#012635", fontSize: "14px", fontWeight: 400, width: "103px", display: "flex", justifyContent: "center", cursor: "pointer", alignItems: "center" }} onClick={toggleDrawer('right', true)}><img src={Assets.Icons.filter} />All Filter</div>
            <Drawer
                anchor='right'
                open={state['right']}

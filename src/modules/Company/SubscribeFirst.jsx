...
const  SubscribeFirst = ({packages = [], selectedPackage={}, setSelectedPackage , packageType ,   setPackageType, isLoading ="" , }) => {
    return (
        <div>
            {
                isLoading === "listing" ? 
            ...
            <div style={{ padding: "0px 20px", marginTop: "15px" }}>
                <div className={styles.subscribeSmallText}>Subscription</div>
                <div>
                    <div style={{ width: "463px" }} className={styles.subscription_cycle}>

...
export default function UpdateStripWarning({ open, setOpen , price , hadleUpgrade}) {
...
//     }
//   }
//   console.log("user?.IsStripeNew", downGradeStep)
  return (
    <div>
      ...
      >
        <Box sx={style}>
          <div style={{ display: "flex", justifyContent: "space-between", height: "58px", alignItems: "center", padding: "0px 16px", borderBottom: "solid 1px #F0F0F0" }}>
            <div style={{ width: "fit-content", fontSize: "18px", fontWeight: 600, lineHeight: "26px", color: "#012635" }}>Upgrade Plan</div><div style={{ width: "fit-content", cursor: "pointer" }} onClick={() => {
              setOpen(false)
          ...
          <div style={{ height: "80px", display: 'flex', alignItems: "center", padding: "0px 16px" }}>
                ...
                <div style={{ color: "#012635", fontSize: "16px", fontWeight: 400 }}>
                  ...
                  Your package would be upgraded and you would be charged ${price}. The new billing cycle would start from today. Are you sure you want to continue?
                </div>
          ...
          <div style={{ display: "flex", justifyContent: "end", gap: "16px", height: "88px", alignItems: "center", padding: "0px 16px", borderTop: "solid 1px #F0F0F0" }}>
            ...
            style={{ backgroundColor: "#00BD82", cursor: "pointer", borderRadius: "8px", color: "white", width: "121px", height: "40px", fontSize: "16px", fontWeight: 500, lineHeight: "24px", display: "flex", justifyContent: "center", alignItems: "center" }}>
              {
                loading == false ?
                  " Yes, Go Ahead!"
                  :

...
export const UsersListStyled = styled.div`
  ...
  & > .bottom {
   ...
   //   gap: 0.5rem;
      ...
      & > .row {
        display: grid;
        // grid-template-columns: repeat(8, minmax(10rem, 1fr)) 12rem;
        // grid-template-columns: repeat(4, minmax(120px, 200px)) 12rem;
        grid-template-columns: minmax(200px, 1fr) repeat(3, minmax(120px, 200px)) minmax(70px, 100px);

...
export default function DeleteModal({ open, setOpen, curruntNumber, handleDelete, rollName }) {
            ...
            >
                <Box sx={style}>
                    <div style={{ display: "flex", justifyContent: "space-between", height: "58px", alignItems: "center", padding: "0px 16px", borderBottom: "solid 1px #F7F7F7" }}>
                        <div style={{ color: "#012635", fontSize: "18px", fontWeight: 600 }}>{rollName}</div> <div><IoMdClose style={{ cursor: "pointer" }} onClick={handleClose} size={24} /></div>
                    </div>
                    <div style={{ paddingTop: "16px" }}>
                        ...
                        <div style={{ fontSize: "16px", color: "#012635", fontWeight: 400, padding: "16px" }}>
                            This will permanently delete this <span style={{ fontWeight: 600 }}>{rollName}</span> . Deleting this roll will delete all associated data.

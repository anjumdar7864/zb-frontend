...
export default function MarkAsReadModall({ open, setOpen, handleSubmit, read, message }) {
    ...
    return (
        <div>
            ...
            >
                <Box sx={style}>
                    <div className='body3SemiBold textPrimeryColor' style={{ display: "flex", justifyContent: "space-between", height: "58px", padding: "0 16px", alignItems: "center",  borderBottom: "solid 1px #F7F7F7" }}><span>Select a Phone </span><span><IoCloseOutline style={{ cursor: "pointer" }} onClick={handleClose} size={24} /></span></div>
                    ...
                    <div style={{ display: "flex", justifyContent: "end", height: "72px", padding: "0 16px", alignItems: "center", fontSize: "18px", fontWeight: 600, color: "#012635", borderTop: "solid 1px #F7F7F7", marginTop: "20px" }}>
                        <button onClick={() => handleSubmit(obj)} className='body4Medium textWhiteColor primeryBackground' style={{ height: "40px", width: "120px", borderRadius: "8px",  textAlign: "center" }}>Save</button>
                    </div>

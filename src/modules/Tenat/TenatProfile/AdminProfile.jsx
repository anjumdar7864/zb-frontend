...
import { GetSingleUser, UpdateLoginTanent, UpdateSingleUser, UpdateSingleUserAgent } from "@/store/actions/auth.action";
...
const AdminProfile = ({ tenantData }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(UpdateLoginTanent(finalResult, Id, "user"));
    },
  });
    ...
    <EditContainer>
      <Flex direction="column" gap="20px">
        ...
        <Card2>
          <div style={{ padding: "20px" }}>
            ...
            <Flex align="start" gap="10px" paddingTop="20px">
              <Flex direction="column" width="30%" xsWidth="100%" position="relative" gap="0.65rem">
                <p style={{ fontWeight: 500, fontSize: "14px" }}>
                  Timezone
                </p>
        ...
        <Card style={{ padding: "20px" }}>
          ...
          <Flex align="start" gap="20px" paddingTop="20px" direction="column">
            <Flex width="100%" align="end" gap="10px">
              ...
              </Flex>
              {
                formikPassword?.values?.email != singleUser?.email && (
                  <Flex direction="column" width="10%" height="fit-content"  >
                    <button
      ...
      >
        <CreateNewCategoryModal onClose={() => { setIsCreateNewCategoryModalOpen(false) }} email={formik?.values?.email} />
      </Components.Common.ModalTop>
    </EditContainer >
  );
};

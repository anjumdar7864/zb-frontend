            ...
            >
              <div className="itemsWrapper">
                ...
                >
                  ...
                  <div>
                    <h5 style={{ fontWeight: "400", forntSize: "32px" }}>
                      {unReadCount}
                    </h5>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    <h5 style={{ fontWeight: "400" }}>{unAnsweredCount}</h5>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    <h5 style={{ fontWeight: "400" }}>{reminderCount}</h5>
                  </div>
                </div>
                <div
                  className={"item updatedItem"}
                ...
                >
                  ...
                  <div>
                    <h5 style={{ fontWeight: "400" }}>{noStatusCount}</h5>
                  </div>
                </div>
              </div>
            </div>

...
const PasswordReset = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      let finalResult = { password: newPassword, resetPasswordToken: token };
      dispatch(CreatePassword(finalResult, id));
    },
  });
  ...
  return (
    ...
    >
      ...
      <div className="top">
            ...
            <div style={{ fontSize: "32px", color: "#012635", fontWeight: 600, lineHeight: "40px", marginBottom: "8px", fontFamily: ' Fellix,  "Helvetica Neue",' }}>Create Password</div>

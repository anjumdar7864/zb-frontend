  ...
  return (
    ...
    <TopHeader>
      ...
      <HeaderStyled>
        <div className="">
          <Link to="/">
            <img src={Assets.Images.zeitBlast_logoA} alt="ZeitBlast" className="signuplogo" />
          </Link>
        </div>
        <Flex className="" align="center" justify="flex-end" >
          <P fontSize="14" fontweight="400" className="signupMessage">
            Already have an account?{" "}
            <Link to={"/login"} style={{ color: "#00bd82" }}>
              Click here
            </Link>
          </P>
        </Flex>

...
// export default function TermAndCondition({ open, setOpen, confirmTerm }) {
...
//                         <div style={{ width: "fit-content", fontSize: "18px", fontWeight: 600, lineHeight: "26px", color: "#012635" }}>JV Contract</div><div style={{ width: "fit-content", cursor: "pointer" }} ><IoMdClose onClick={() => setOpen(false)} style={{ fontSize: "24px", color: "#012635" }} /></div>
...
//                             />
//                         </div>
//                         <div>Please Read and Accept the JV Contract to continue.</div>
//                     </div>
...
//                         <div onClick={() => setOpen(false)} style={{ border: "solid 1px #777777", cursor: "pointer", borderRadius: "8px", color: "#777777", width: "100px", height: "40px", fontSize: "16px", fontWeight: 500, lineHeight: "24px", display: "flex", justifyContent: "center", alignItems: "center" }}>Cancel</div>
//                         <div  onClick={()=>{
//                             if(check){
//                                 confirmTerm()
//                                 setCheck(false)
...
const TermsAndCondition = ({ open, setOpen, confirmTerm }) => {
    const handleOpen = () => setOpen(true);
    const handleClose = () => setOpen(false);
    const [check, setCheck] = React.useState(false)
    const [loading, setLoader] = React.useState(false);
    ...
    return (
        <div>
            ...
            >
                <Box sx={style}>
                    <div style={{ display: "flex", justifyContent: "space-between", height: "58px", alignItems: "center", padding: "0px 16px", borderBottom: "solid 1px #F0F0F0" }}>
                        <div style={{ width: "fit-content", fontSize: "18px", fontWeight: 600, lineHeight: "26px", color: "#012635" }}>Terms & Conditions</div><div style={{ width: "fit-content", cursor: "pointer" }} ><IoMdClose onClick={() =>{ 
                            setOpen(false)
                            setCheck(false)
                            }} style={{ fontSize: "24px", color: "#012635" }} /></div>

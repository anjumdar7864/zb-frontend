        ...
        <div className={styles.innerBreadcrumbs}>
          <div>
            <h6 style={{cursor:'pointer'}} onClick={() => {
              if(location.pathname == "/templates/create-template"){
                navigate("/templates/initial-templates")
              }
              if(location.pathname == `/templates/create-template/${templateId}`){
                navigate("/templates/initial-templates")
              }
              if(location.search == "?follow=true"){
                navigate("/templates/follow-up-messages")
              }
              if(location.pathname == "/templates/create-replies"){
                navigate("/templates/quick-replies")
              }
              if(location.pathname == `/templates/create-replies/${templateId}`){
                navigate("/templates/quick-replies")
              }
